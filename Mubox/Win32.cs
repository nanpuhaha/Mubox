        ...
        public static class SendInputApi
        {
            ...
            internal static void SendInputViaKBParams(Win32.WindowHook.LLKHF flags, uint time, uint scan, uint vk, Win32.CAS cas)
            {
                if ((flags & WindowHook.LLKHF.UP) != WindowHook.LLKHF.UP)
                {
                    ...
                    {
                        SendInputViaKBParams((WindowHook.LLKHF)0, time, (uint)0, (uint)Win32.VK.Control, (CAS)0);
                    }
                    if ((cas & CAS.ALT) != 0)
                    {
                        SendInputViaKBParams((WindowHook.LLKHF)0, time, (uint)0, (uint)Win32.VK.Menu, (CAS)0);
                        flags |= WindowHook.LLKHF.ALTDOWN;
                    }
                    if ((cas & CAS.SHIFT) != 0)
                    {
                        SendInputViaKBParams((WindowHook.LLKHF)0, time, (uint)0, (uint)Win32.VK.Shift, (CAS)0);
                    }
                }
                ...
                if (IntPtr.Size == 8)
                {
                    ...
                    input[0].ki.VirtualKey = (Win32.VK)vk;
                ...
                if ((flags & WindowHook.LLKHF.UP) == WindowHook.LLKHF.UP)
                {
                    if ((cas & CAS.CONTROL) != 0)
                    {
                        SendInputViaKBParams(WindowHook.LLKHF.UP, time, (uint)0, (uint)Win32.VK.Control, (CAS)0);
                    }
                    if ((cas & CAS.ALT) != 0)
                    {
                        SendInputViaKBParams(WindowHook.LLKHF.UP, time, (uint)0, (uint)Win32.VK.Menu, (CAS)0);
                    }
                    if ((cas & CAS.SHIFT) != 0)
                    {
                        SendInputViaKBParams(WindowHook.LLKHF.UP, time, (uint)0, (uint)Win32.VK.Shift, (CAS)0);
                    }
                }
            }
            ...
            internal static KeyEventFlags ConvertFlags(WindowHook.LLKHF flags)
            {
                ...
                if (Win32.WindowHook.LLKHF.EXTENDED == (Win32.WindowHook.LLKHF.EXTENDED & flags))
                {
